...
def time_range_options(f):
    ...
    f = click.option(
        ...
        type=str,
        default=None,
        help="Start date/time for analysis period (ISO 8601 or natural language: yesterday, last month, Monday, 3 weeks ago, last Tuesday)",
    )(f)
    f = click.option(
        "-u",
        "--until",
        type=str,
        default=None,
        help="End date/time for analysis period (ISO 8601 or natural language: yesterday, last month, Monday, 3 weeks ago, last Tuesday)",
    )(f)
    f = click.option(
        "--period",
